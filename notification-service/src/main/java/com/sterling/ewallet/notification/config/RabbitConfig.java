package com.sterling.ewallet.notification.config;
...
public class RabbitConfig {
    ...
    public Queue passwordResetQueue() {
        return new Queue(RabbitTopics.PASSWORD_RESET_QUEUE, true);
    }

    @Bean
    public Binding passwordResetBinding(Queue passwordResetQueue, TopicExchange ewalletExchange) {
        return BindingBuilder.bind(passwordResetQueue).to(ewalletExchange)
                .with(RabbitTopics.PASSWORD_RESET_ROUTING_KEY);
    }
